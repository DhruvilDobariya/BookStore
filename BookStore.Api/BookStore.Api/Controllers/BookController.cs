...
namespace BookStore.Api.Controllers
{
    ...
    public class BookController : ControllerBase
    {
        ...
        [HttpGet]
        [Route("list")]
        public async Task<IActionResult> GetBooksAsync(string? keyword = "", int pageIndex = 1, int pageSize = 10)
        {
            var books = await _bookRepository.GetBooksAsync(pageIndex, pageSize, keyword);
